...
import { DISCUSSION_TYPE_LABELS, isoDate, VISIT_PURPOSE_LABELS } from '@/lib/erp/format'
      ...
      <div className="fixed inset-x-0 bottom-20 z-20 border-t border-gray-200 bg-white/95
        ...
        <div className="mx-auto flex max-w-3xl items-center gap-3">
          <div className="min-w-0 flex-1 text-[12px] text-gray-500">
            ...
            {orderReceived && orderBookNumber.trim() && (
              <span>{discussed.length > 0 ? ' · ' : ''}Order book {orderBookNumber.trim()}</span>
            )}
          </div>
          <button
            type="button"
