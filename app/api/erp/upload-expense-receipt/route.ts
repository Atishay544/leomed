...
/**
 * Upload a receipt attached to an expense claim. Same pattern as
 * /api/erp/upload-visit-photo — gated by expenses.submit (any staff member
 * who can submit an expense), not adminGuard.
 */
...
export async function POST(req: NextRequest) {
  ...
  if (!can(session.role, 'expenses.submit')) {
